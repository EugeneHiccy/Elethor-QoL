...
// @author       Eugene
// @match        https://elethor.com/character/companion/recyclobot
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    calculatorContainer.querySelector('#calculateBtn').addEventListener('click', () => {
        ...
        while (true) {
            ...
            const goldGainedFromPlatinum = totalPlatinum * goldPerPlatinum * 1_000_000; // Convert millions to actual value
        ...
        document.getElementById('results').innerHTML = `
            <p style="color: #dee5ed;">Total Platinum Produced: ${platinumCount}</p>
            <p style="color: #dee5ed;">Total Gold Profit: ${formatToBillions(totalGoldProfit)}</p>
            <p style="color: #dee5ed;">Total Gold Spent: ${formatToBillions(totalGoldSpent)}</p>
        `;
    });
